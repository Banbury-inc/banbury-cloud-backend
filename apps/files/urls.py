...
urlpatterns = [
    ...
    path("get_s3_files/<str:username>/", views.get_s3_files, name="get_s3_files"),
    path("download_s3_file/<str:username>/<str:file_id>/", views.download_s3_file_view, name="download_s3_file"),
]
