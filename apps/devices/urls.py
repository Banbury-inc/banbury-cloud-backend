...
urlpatterns = [
    ...
    path("add_downloaded_model/", views.add_downloaded_model_view, name="add_downloaded_model_new"),
    path("remove_downloaded_model/", views.remove_downloaded_model_view, name="remove_downloaded_model"),
